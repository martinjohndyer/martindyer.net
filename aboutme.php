<!DOCTYPE html>
<html lang="en">
<title>About me | Martin Dyer</title>
...
<div class="w3-display-container w3-center w3-black" style="margin-top:46px">
	<img class="w3-image" style="height:500px; object-fit: cover" src="/images/wide_sheffield.jpg" alt="Banner">
	<div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-8 w3-black">
		<h1><font size="32"><b>About me</b></font></h1>
	</div>
</div>
